...
def final_stage4_calculate_output(S1, stage_3_Sum_HA_1, stage_3_Sum_HA_2, stage_3_Sum_FA_1, stage_3_Sum_FA_2, stage_3_Sum_FA_3, \
    ...
    final_Sum = 12 + S1 * 2**5 + stage_3_Sum_HA_1 * 2**6 + stage_3_Sum_FA_1 * 2**7 + stage_3_Sum_FA_2 * 2**8 + stage_3_Sum_HA_2 * 2**9 \
...
def generate_all_results():
    ...
    for a_int in range(256):
        for b_int in range(256):
            ...
            final_Sum = final_stage4_calculate_output(S1, stage_3_Sum_HA_1, stage_3_Sum_HA_2, stage_3_Sum_FA_1, stage_3_Sum_FA_2, stage_3_Sum_FA_3, stage_3_Sum_FA_4, stage_3_Sum_FA_5, stage_3_Sum_FA_6, stage_3_Sum_FA_7, stage_3_Cout_FA_7)
...
# 将结果输出到 Excel
def export_to_excel(results, filename='results.xlsx'):
