...
def stage_1_calculate_output(pp, a, b):
    ...
    inputs_S_extra = [pp[0][4], pp[1][3], pp[2][2], pp[3][1]]
    inputs_S1 = [pp[0][5], pp[1][4], pp[2][3], pp[3][2]]
    inputs_S2 = [pp[0][6], pp[1][5], pp[2][4], pp[3][3]]
    inputs_S3 = [pp[0][7], pp[1][6], pp[2][5], pp[3][4]]

    inputs_C1 = [pp[4][1], pp[5][0]]
    inputs_C2 = [pp[4][2], pp[5][1], pp[6][0]]
    inputs_C3 = [pp[4][3], pp[5][2], pp[6][1], pp[7][0]]

    # 计算或门输出
    S_extra = any(inputs_S_extra)
    S1 = any(inputs_S1)
    S2 = any(inputs_S2)
    S3 = any(inputs_S3)
    ...
    # Cout_HA = p1 & p2
    Cout_HA = pp[6][2] & pp[7][2]

    # Sum_HA = p1 ^ p2
    Sum_HA = pp[6][2] ^ pp[7][2]  
    
    return S_extra, S1, S2, S3, C1, C2, Carry_exact_compressor_1, \
...
def stage_2_calculate_output(pp, Carry_exact_compressor_1, Carry_exact_compressor_2, Carry_exact_compressor_3, 
    ...
    # 使用 stage1 的输出进行计算
    stage2_Cout_HA_extra = S_extra & pp[4][0]
    stage2_Sum_HA_extra = S_extra ^ pp[4][0]
    ...
    return stage2_Cout_HA_extra, stage2_Sum_HA_extra, stage2_Sum_exact_compressor_1, stage2_Sum_exact_compressor_2, stage2_Sum_exact_compressor_3, stage2_Sum_exact_compressor_4, stage2_Sum_FA,\
...
# 计算stage3的输出
def stage_3_calculate_output(pp, S1, S2, S3, C1, C2, Sum_exact_compressor_1, Sum_FA_1,
                            ...
                            stage2_Carry_exact_compressor_1, stage2_Carry_exact_compressor_2, stage2_Carry_exact_compressor_3, stage2_Carry_exact_compressor_4, stage2_Cout_FA,
                            stage2_Cout_HA_extra):
    
# 使用 stage2 的输出进行计算
    stage3_Cout_HA_extra = S1 & stage2_Cout_HA_extra
    stage3_Sum_HA_extra = S1 ^ stage2_Cout_HA_extra

#stage_3_Cout_FA_extra = (p1 & p2) | Cin & (p1 | p2)
#stage_3_Sum_FA_extra = p1 ^ p2 ^ Cin



    #stage3_HA1 --> stage_3_FA_extra
    stage_3_Cout_FA_extra = C1 & S2 | stage3_Cout_HA_extra & (C1 | S2)
    stage_3_Sum_FA_extra = C1 ^ S2 ^ stage3_Cout_HA_extra



#stage_3_Cout_FA = (p1 & p2) | Cin & (p1 | p2)
    stage_3_Cout_FA_1 = C2 & S3 | stage_3_Cout_FA_extra & (C2 | S3)
...
#stage_3_Sum_FA = (p1 ^ p2) ^ Cin
    stage_3_Sum_FA_1 = C2 ^ S3 ^ stage_3_Cout_FA_extra
    ...
    return stage3_Sum_HA_extra, stage_3_Sum_FA_extra, stage_3_Sum_HA_2, stage_3_Sum_FA_1, stage_3_Sum_FA_2, stage_3_Sum_FA_3, \
...
# 计算最终输出
def final_stage4_calculate_output(stage_3_Sum_HA_2, stage_3_Sum_FA_1, stage_3_Sum_FA_2, stage_3_Sum_FA_3, \
           stage_3_Sum_FA_4, stage_3_Sum_FA_5, stage_3_Sum_FA_6, stage_3_Sum_FA_7, stage_3_Cout_FA_7, \
          stage2_Sum_HA_extra, stage3_Sum_HA_extra, stage_3_Sum_FA_extra):
    
    final_Sum = 0 + stage2_Sum_HA_extra * 2**4 + stage3_Sum_HA_extra * 2**5 + stage_3_Sum_FA_extra * 2**6 + stage_3_Sum_FA_1 * 2**7 + stage_3_Sum_FA_2 * 2**8 + stage_3_Sum_HA_2 * 2**9 \
...
def generate_all_results():
    ...
    for a_int in range(256):
        for b_int in range(256):
            ...
            b = f'{b_int:08b}'
            pp = calculate_partial_products(a, b)
            S_extra, S1, S2, S3, C1, C2, Carry_exact_compressor_1, Carry_exact_compressor_2, Carry_exact_compressor_3, Sum_exact_compressor_1, Sum_exact_compressor_2, Sum_exact_compressor_3, Sum_FA_1, Sum_FA_2, Cout_FA_1, Cout_FA_2, Cout_HA, Sum_HA = stage_1_calculate_output(pp, a, b)
            stage2_Cout_HA_extra, stage2_Sum_HA_extra, stage2_Sum_exact_compressor_1, stage2_Sum_exact_compressor_2, stage2_Sum_exact_compressor_3, stage2_Sum_exact_compressor_4, stage2_Sum_FA, stage2_Carry_exact_compressor_1, stage2_Carry_exact_compressor_2, stage2_Carry_exact_compressor_3, stage2_Carry_exact_compressor_4, stage2_Cout_FA = stage_2_calculate_output(pp, Carry_exact_compressor_1, Carry_exact_compressor_2, Carry_exact_compressor_3, Sum_exact_compressor_2, Sum_exact_compressor_3, Sum_FA_2, Cout_FA_1, Cout_FA_2, Cout_HA, Sum_HA, S_extra)
            stage3_Sum_HA_extra, stage_3_Sum_FA_extra, stage_3_Sum_HA_2, stage_3_Sum_FA_1, stage_3_Sum_FA_2, stage_3_Sum_FA_3, stage_3_Sum_FA_4, stage_3_Sum_FA_5, stage_3_Sum_FA_6, stage_3_Sum_FA_7, stage_3_Cout_FA_7 = stage_3_calculate_output(pp, S1, S2, S3, C1, C2, Sum_exact_compressor_1, Sum_FA_1, stage2_Sum_exact_compressor_1, stage2_Sum_exact_compressor_2, stage2_Sum_exact_compressor_3, stage2_Sum_exact_compressor_4, stage2_Sum_FA, stage2_Carry_exact_compressor_1, stage2_Carry_exact_compressor_2, stage2_Carry_exact_compressor_3, stage2_Carry_exact_compressor_4, stage2_Cout_FA, stage2_Cout_HA_extra)
            final_Sum = final_stage4_calculate_output(stage_3_Sum_HA_2, stage_3_Sum_FA_1, stage_3_Sum_FA_2, stage_3_Sum_FA_3, stage_3_Sum_FA_4, stage_3_Sum_FA_5, stage_3_Sum_FA_6, stage_3_Sum_FA_7, stage_3_Cout_FA_7, stage2_Sum_HA_extra, stage3_Sum_HA_extra, stage_3_Sum_FA_extra)
...
# 将结果输出到 Excel
def export_to_excel(results, filename='Tr4bit_results.xlsx'):
