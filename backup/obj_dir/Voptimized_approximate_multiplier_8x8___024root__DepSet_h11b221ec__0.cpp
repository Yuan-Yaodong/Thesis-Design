...
#endif
            VL_FATAL_MT("optimized_approximate_multiplier_8x8.v", 6, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("optimized_approximate_multiplier_8x8.v", 6, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("optimized_approximate_multiplier_8x8.v", 6, "", "Active region did not converge.");
            }
